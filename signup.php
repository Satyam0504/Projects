...
<body background = "/img/back1.jpg">
	<button class="button5 button6" onClick="self.close();window.open('index.php')">Back         </button><br><br><br></div>
...
<a href = "../proj/policy.html" target = "_blank">Terms And Policy</a>
<br>
<br>
